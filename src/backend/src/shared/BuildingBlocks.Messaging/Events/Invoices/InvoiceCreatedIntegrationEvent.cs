...
{
    public InvoiceCreatedIntegrationEvent(Guid id, string numberInvoice, DateTime issueDate, Guid? customerId,
        decimal total, Guid correlationId, IEnumerable<InvoiceLines> lines)
    {
        Id = id;
